...
function ExploreContent() {
    ...
    return (
        <div className="container mx-auto px-4 md:px-6">
            ...
            {/* Enhanced Search Bar */}
            <div className="flex flex-col sm:flex-row items-center gap-4 mb-10 max-w-2xl mx-auto w-full">
                <div className="relative w-full">
                    <div className="relative flex items-center bg-card border border-border rounded-lg p-1.5 focus-within:ring-1 focus-within:ring-primary focus-within:border-primary">
                        ...
                        <input 
                            ...
                            className="w-full py-2 px-3 bg-transparent focus:outline-none text-foreground placeholder:text-muted-foreground/70 text-base"
                            value={searchQuery}
